...
public class DocentesForm extends javax.swing.JInternalFrame {
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if (fila == -1) {
            ...
            Date date4;
            try {
                date = new SimpleDateFormat("yyy-MM-dd").parse(tabla.getValueAt(fila, 7).toString());
                CalendarIngresoSep.setDate(date);
                date2 = new SimpleDateFormat("yyy-MM-dd").parse(tabla.getValueAt(fila, 8).toString());
                CalendarIngresoESC.setDate(date2);
                date3 = new SimpleDateFormat("yyy-MM-dd").parse(tabla.getValueAt(fila, 9).toString());
                CalendarIngresoZN.setDate(date3);
                date4 = new SimpleDateFormat("yyy-MM-dd").parse(tabla.getValueAt(fila, 10).toString());
                CalendarFechaNacimiento.setDate(date4);
            } catch (ParseException ex) {
                getLogger(DocentesForm.class.getName()).log(SEVERE, null, ex);
            }
    ...
    void agregar() {
        ...
        if (txtNombreCompleto.getText().equals("") & txtCodigoPresupuestal.getText().equals("")
            ...
            int año = CalendarIngresoSep.getCalendar().get(YEAR);
            int dia = CalendarIngresoSep.getCalendar().get(DAY_OF_MONTH);
            int mes = CalendarIngresoSep.getCalendar().get(MONTH);

            int año2 = CalendarIngresoESC.getCalendar().get(YEAR);
            int dia2 = CalendarIngresoESC.getCalendar().get(DAY_OF_MONTH);
            int mes2 = CalendarIngresoESC.getCalendar().get(MONTH);

            int año3 = CalendarIngresoZN.getCalendar().get(YEAR);
            int dia3 = CalendarIngresoZN.getCalendar().get(DAY_OF_MONTH);
            int mes3 = CalendarIngresoZN.getCalendar().get(MONTH);

            int año4 = CalendarFechaNacimiento.getCalendar().get(YEAR);
            int dia4 = CalendarFechaNacimiento.getCalendar().get(DAY_OF_MONTH);
            int mes4 = CalendarFechaNacimiento.getCalendar().get(MONTH);
