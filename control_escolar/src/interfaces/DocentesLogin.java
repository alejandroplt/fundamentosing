...
//        btn1.setBorderPainted(false);
    ...
    public void validar() {
        ...
        if (txtUser.getText().equals("") || txtPass.getText().equals("")) {
            showMessageDialog(this, "Ingrese su nombre de usuario y contraseña");
            txtUser.setText("");
            txtPass.setText("");
            ...
            if (ev.getContraseña() != null && ev.getNo_identifi() != null) {
                ...
                showMessageDialog(this, "El nombre de usuario o contraseña son incorrectos");
                txtUser.setText("");
                txtPass.setText("");
                txtUser.requestFocus();
            }
...
////         */
        try {
            ...
            getLogger(DocentesLogin.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            new DocentesLogin().setVisible(true);
        });
    }
