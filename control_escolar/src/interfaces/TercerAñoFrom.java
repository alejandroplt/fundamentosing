...
import modelos.TercerAño;
import modelos.TercerAñoDAO;
import modelos.conexion;

public class TercerAñoFrom extends javax.swing.JInternalFrame {

    TercerAñoDAO dao = new TercerAñoDAO();
    TercerAño v = new TercerAño();
    ...
    void listar() {
        List<TercerAño> lista = dao.listar();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("ASIGNACION TERCER AÑO");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(ComboDocente, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
                                .addGap(15, 15, 15))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(cmb_iddocente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ComboDocenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboDocenteActionPerformed
        // TODO add your handling code here:
        int indice_cmbalumno = ComboDocente.getSelectedIndex();
        cmb_iddocente.setSelectedIndex(indice_cmbalumno);
    }//GEN-LAST:event_ComboDocenteActionPerformed

    void agregar() {
        if (cmb_idgrupo.getSelectedIndex() == 0 || ComboAlumno.getSelectedIndex() == 0 || ComboDocente.getSelectedIndex() == 0) {
            ...
            int combdoc = Integer.parseInt(cmb_iddocente.getSelectedItem().toString());//ComboDocente.
