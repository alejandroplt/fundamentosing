...
import modelos.VerCali1DAO;
import modelos.VerCali1;
import modelos.conexion;

public class VerRegistroCalificaciones1 extends javax.swing.JInternalFrame {

    VerCali1DAO dao = new VerCali1DAO();
    VerCali1 v = new VerCali1();
    ...
    public VerRegistroCalificaciones1() {
        initComponents();
//        listar();
        mostraralumno();
    ...
    void listar() {
        List<VerCali1> lista = dao.listar();
...
//            ob[7] = lista.get(i).getNombreCompleto();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("CALIFICACIONES PRIMER AÑO");
