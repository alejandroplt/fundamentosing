...
import modelos.VerCali2DAO;
import modelos.VerCali2;
import modelos.conexion;

public class VerRegistroCalificaciones2 extends javax.swing.JInternalFrame {

    VerCali2DAO dao = new VerCali2DAO();
    VerCali2 v = new VerCali2();
    ...
    public VerRegistroCalificaciones2() {
        initComponents();
//        listar();
        mostraralumno();
    ...
    void listar() {
        List<VerCali2> lista = dao.listar();
...
//            ob[7] = lista.get(i).getNombreCompleto();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("CALIFICACIONES SEGUNDO AÑO");
